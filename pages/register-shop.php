...
<section class="auth-split auth-split-wide">
  <div class="auth-split-photo">
    ...
    <div class="auth-split-content">
      ...
      <h2>Sell to travelers<br>exploring Laguna.</h2>
      <p>List your milk tea stand, café, or souvenir shop and reach tourists building their itinerary right now.</p>
    </div>
  </div>
  ...
  <div class="auth-split-form">
    <div class="auth-form-inner fade-up">
      ...
      <h2 class="auth-heading"><?= $step === 1 ? 'Register as Shop Owner' : 'Set Up Your Shop' ?></h2>
